...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.btnCaledarcli = QtWidgets.QPushButton(parent=self.pesClientes)
        self.btnCaledarcli.setMinimumSize(QtCore.QSize(30, 30))
        self.btnCaledarcli.setMaximumSize(QtCore.QSize(28, 16777215))
