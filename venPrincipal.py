...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.gridLayout.addWidget(self.chkHisoriacli, 2, 18, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout.addItem(spacerItem6, 4, 8, 1, 1)
        ...
        self.actionRestaurar_Backup.setIcon(icon2)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(".\\templates\\../../../../.designer/img/salir.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
